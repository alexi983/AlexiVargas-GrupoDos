...
export default function ItemDetail() {
    ...
    return (
        <div className='container mx-auto max-w-[1170px]'>
            {successMessage && (
                <div className="bg-cyan-500 text-white p-3 rounded mb-4">
                    {successMessage}
                </div>
            )}
            <div className="grid grid-cols-2 pt-[50px] pb-[100px]">
                ...
                <div>
                    ...
                    <div className='flex'>
                        <button onClick={decrementQuantity} className='rounded-[5px] hover:bg-teal-400 hover:text-[#ffffff] w-[50px] border-[1px] text-[20px] flex justify-center'> - </button>
                        <p className='text-[20px] px-[10px]'>{quantity}</p>
                        <button onClick={incrementQuantity} className='rounded-[5px] hover:bg-teal-400 hover:text-[#ffffff] w-[50px] border-[1px] text-[20px] flex justify-center'> + </button>
                    </div>
